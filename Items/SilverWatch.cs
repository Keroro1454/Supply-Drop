...
namespace SupplyDrop.Items
{
    public class SilverWatch : ItemBase<SilverWatch>
    {
        ...
        public override string ItemFullDescription => $"All <style=cIsUtility>buff</style> durations are increased by {FloatToPercentageString(baseDurationIncrease)} <style=cStack>(+{FloatToPercentageString(addDurationIncrease)} " +
            $"per stack)</style>. All <style=cDeath>debuff</style> durations are also increased by {FloatToPercentageString(baseDurationIncrease)} <style=cStack>(+{FloatToPercentageString(addDurationIncrease)} " +
            $"per stack)</style>.";
        ...
        public override void Init(ConfigFile config)
        {
            ...
            ItemDef.pickupModelPrefab.transform.eulerAngles = new Vector3(180, 180, 180);
        ...
        public override ItemDisplayRuleDict CreateItemDisplayRules()
        {
            ...
            rules.Add("mdlSeeker", new ItemDisplayRule[]
            {
                new ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab, followerPrefabAddress = new AssetReferenceGameObject(""),
                    childName = "Stomach",
                    localPos = new Vector3(0.17101F, -0.04491F, -0.04707F),
                    localAngles = new Vector3(305.0693F, 293.3848F, 174.1937F),
            ...
            rules.Add("mdlFalseSon", new ItemDisplayRule[]
            {
                new ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab, followerPrefabAddress = new AssetReferenceGameObject(""),
                    childName = "LowerArmL",
                    localPos = new Vector3(0.10594F, 0.66608F, -0.06378F),
                    localAngles = new Vector3(62.63433F, 303.3766F, 347.9888F),
                    localScale = new Vector3(3.01578F, 3.01578F, 3.01578F)
                }
            });
            rules.Add("mdlChef", new ItemDisplayRule[]
            {
                new ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab, followerPrefabAddress = new AssetReferenceGameObject(""),
                    childName = "Chest",
                    localPos = new Vector3(0.38388F, -0.3772F, 0.25706F),
                    localAngles = new Vector3(349.4099F, 306.9099F, 90.92753F),
                    localScale = new Vector3(1.40651F, 1.40651F, 1.40651F)
                }
            });
            rules.Add("mdlDroneTech", new ItemDisplayRule[]
            {
                new ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab, followerPrefabAddress = new AssetReferenceGameObject(""),
                    childName = "Gun",
                    localPos = new Vector3(-0.04954F, -0.04184F, 0.01326F),
                    localAngles = new Vector3(291.5633F, 58.87081F, 201.5732F),
                    localScale = new Vector3(0.54486F, 0.54486F, 0.54486F)
                }
            });
            rules.Add("mdlDrifter", new ItemDisplayRule[]
            {
                new ItemDisplayRule
                {
                    ...
                    localPos = new Vector3(-0.24272F, 0.49194F, -0.00229F),
                    localAngles = new Vector3(340.4597F, 95.63831F, 171.4837F),
                    localScale = new Vector3(1.20861F, 1.20861F, 1.20861F)
                }
            });
            ...
            rules.Add("mdlMiner", new RoR2.ItemDisplayRule[]
            {
                new RoR2.ItemDisplayRule
                {
                    ...
                    followerPrefab = ItemBodyModelPrefab, followerPrefabAddress = new AssetReferenceGameObject(""),
                    childName = "Pelvis",
                    localPos = new Vector3(-0.00085F, 0.00062F, -0.00157F),
                    localAngles = new Vector3(291.1111F, 290.4544F, 305.7036F),
                    localScale = new Vector3(0.01516F, 0.01516F, 0.01516F)
                }
            });
        ...
        {
            On.RoR2.CharacterBody.AddTimedBuff_BuffDef_float += NewDurationApplicator;
        }

        private void NewDurationApplicator(On.RoR2.CharacterBody.orig_AddTimedBuff_BuffDef_float orig, CharacterBody self, BuffDef buffDef, float duration)
        {
            ...
            if (inventoryCount > 0)
            {
                duration = Mathf.Max(duration + (duration * baseDurationIncrease) + (duration * addDurationIncrease * (inventoryCount - 1)), duration);
            }
        }
    }
}