...
namespace SupplyDrop.Items
{
    class HardenedBoneFragments : Item_V2<HardenedBoneFragments>
    {
        ...
        protected override string GetDescString(string langID = null) => "Gain <style=cIsUtility>1</style> <style=cStack>(+1 per stack)</style> <style=cIsUtility>armor</style> on kill. " +
